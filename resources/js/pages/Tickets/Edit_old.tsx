...
export default function Edit() {
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        equipment_area: ticket.equipment_area || '',
    ...
    const handleCancel = () => {
        if (
            ...
            data.equipment_category !== (ticket.equipment_category || '') ||
            data.equipment_name !== (ticket.equipment_name || '') ||
            data.equipment_serial !== (ticket.equipment_serial || '') ||
            data.equipment_area !== (ticket.equipment_area || '') ||
